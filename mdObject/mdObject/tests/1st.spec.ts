...
describe('$mdObject.Immunization tests', () => {
    ...
    it('reasonNotGiven assigned', () => expect(im.reasonNotGiven).toEqual('Parent Refusal'));
    it('historical', () => expect(im.historical).toEqual('NotHistorical'));
    it('historicalSource', () => expect(im.historicalSource).toEqual('historicalSource'));
    it('vfcElegibility', () => expect(im.vfcElegibility).toEqual('V01'));
